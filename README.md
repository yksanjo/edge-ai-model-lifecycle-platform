# edge-ai-model-lifecycle-platform

## Detailed Description

edge-ai-model-lifecycle-platform is a iot-focused project that evaluates device telemetry and operational anomalies to improve fleet reliability and safety.  
